...
files = [
    "external_validation/gnpy/raw_outputs/gnpy_holdout_flat_1span.txt",
    "external_validation/gnpy/raw_outputs/gnpy_holdout_flat_4span.txt",
    "external_validation/gnpy/raw_outputs/gnpy_holdout_flat_8span.txt",
]
